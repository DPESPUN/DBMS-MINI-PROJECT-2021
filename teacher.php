 ...
 <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
			...
			<li><a href="statistics.php">Defaulters</a></li>
  ...
  <div class="container">
    <?php
      ...
      <button type="button" class="btn btn-primary btn-lg">Add-class</button>
        </div>
      </div>';   
    ?>
        ...
        <div class="modal-content">
          ...
          <hr>
            <div id="add_class_form">
              ...
              <input class="form-control" name="code" placeholder="Code , Eg : 1234">
